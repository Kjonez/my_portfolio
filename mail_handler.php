...
$mail->addAddress('joshhuber.dev@gmail.com', 'joshuahuber'); /*your email address, or the email the sender if you are sending confirmation*/ /*email address user name*/    // Add a recipient
